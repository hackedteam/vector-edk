...
typedef struct devoptab_ {
    ...
    void	*deviceData;	// device data

} devoptab_t;

#define ntfsLock(vd)	/*vd->lock = 1*/
#define ntfsUnlock(vd)	/*vd->lock = 0*/

///* Lock volume */
//static void ntfsLock (ntfs_vd *vd)
//{
//    LWP_MutexLock(vd->lock);
//}
//
///* Unlock volume */
//static void ntfsUnlock (ntfs_vd *vd)
//{
