...
#define  test_nino_flag(ni, flag)	   test_bit(flag, (ni)->state)
#define   set_nino_flag(ni, flag)	    set_bit(flag, (ni)->state)
#define clear_nino_flag(ni, flag)	  clear_bit(flag, (ni)->state)

#define test_and_set_nino_flag(ni, flag)	\
				   test_and_set_bit(flag, (ni)->state)
#define test_and_clear_nino_flag(ni, flag)	\
				 test_and_clear_bit(flag, (ni)->state)

#define NInoDirty(ni)				  test_nino_flag(ni, NI_Dirty)
#define NInoSetDirty(ni)			   set_nino_flag(ni, NI_Dirty)
#define NInoClearDirty(ni)			 clear_nino_flag(ni, NI_Dirty)
#define NInoTestAndSetDirty(ni)		  test_and_set_nino_flag(ni, NI_Dirty)
#define NInoTestAndClearDirty(ni)	test_and_clear_nino_flag(ni, NI_Dirty)

#define NInoAttrList(ni)			  test_nino_flag(ni, NI_AttrList)
#define NInoSetAttrList(ni)			   set_nino_flag(ni, NI_AttrList)
#define NInoClearAttrList(ni)			 clear_nino_flag(ni, NI_AttrList)


#define  test_nino_al_flag(ni, flag)	 test_nino_flag(ni, flag)
#define   set_nino_al_flag(ni, flag)	  set_nino_flag(ni, flag)
#define clear_nino_al_flag(ni, flag)	clear_nino_flag(ni, flag)

#define test_and_set_nino_al_flag(ni, flag)	\
				 test_and_set_nino_flag(ni, flag)
#define test_and_clear_nino_al_flag(ni, flag)	\
			       test_and_clear_nino_flag(ni, flag)

#define NInoAttrListDirty(ni)			    test_nino_al_flag(ni, NI_AttrListDirty)
#define NInoAttrListSetDirty(ni)		     set_nino_al_flag(ni, NI_AttrListDirty)
#define NInoAttrListClearDirty(ni)		   clear_nino_al_flag(ni, NI_AttrListDirty)
#define NInoAttrListTestAndSetDirty(ni)	    test_and_set_nino_al_flag(ni, NI_AttrListDirty)
#define NInoAttrListTestAndClearDirty(ni) test_and_clear_nino_al_flag(ni, NI_AttrListDirty)

#define NInoFileNameDirty(ni)                 test_nino_flag(ni, NI_FileNameDirty)
#define NInoFileNameSetDirty(ni)               set_nino_flag(ni, NI_FileNameDirty)
#define NInoFileNameClearDirty(ni)           clear_nino_flag(ni, NI_FileNameDirty)

#define NInoFileNameTestAndSetDirty(ni)		test_and_set_nino_flag(ni, NI_FileNameDirty)

#define NInoFileNameTestAndClearDirty(ni)	test_and_clear_nino_flag(ni, NI_FileNameDirty)
...
#define ntfs_time_update_flags int
#define NTFS_UPDATE_ATIME (1 << 0)
#define NTFS_UPDATE_MTIME (1 << 1)
#define NTFS_UPDATE_CTIME (1 << 2)
