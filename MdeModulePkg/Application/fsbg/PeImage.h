...
#define EFI_IMAGE_FIRST_SECTION(ntheader) \
    ( \
      (EFI_IMAGE_SECTION_HEADER *) \
        ( \
          (UINT64) ntheader + \
          EFI_FIELD_OFFSET (EFI_IMAGE_NT_HEADERS64, OptionalHeader) + \
...
#define EFI_IMAGE_FIRST_SECTION(ntheader) \
    ( \
      (EFI_IMAGE_SECTION_HEADER *) \
        ( \
          (UINT32) ntheader + \
          EFI_FIELD_OFFSET (EFI_IMAGE_NT_HEADERS32, OptionalHeader) + \
          ((EFI_IMAGE_NT_HEADERS32 *) (ntheader))->FileHeader.SizeOfOptionalHeader \
        ) \
    )
#endif
