...
public:
    ...
    // bygio
    UINT8 saveImageFile(QModelIndex & index,int argc, char *argv[]);
    void SetFatIndex(QModelIndex & index);
    QModelIndex GetFatIndex();
    void SetPosIndex(QModelIndex & index);
    QModelIndex GetPosIndex();
